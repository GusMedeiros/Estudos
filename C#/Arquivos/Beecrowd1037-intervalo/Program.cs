...
else if (25 < valor && valor <= 50) Console.WriteLine("Intervalo (25,50]");
else if (50 < valor && valor <= 75) Console.WriteLine("Intervalo (50,75]");
else if (75 < valor && valor <= 100) Console.WriteLine("Intervalo (75,100]");
